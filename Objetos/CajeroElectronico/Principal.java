public class Principal{
	public static void main(String[] args) {
		...
		// Pruebas
		CajeroElectronico cj_01 = new CajeroElectronico(3, 250000000, 1500000, 4500000, 50, 50, 0, 0, "BancoSena", "andres9649", "12345");
		...
		cj_01.cambiarClave(tj_01, "54321");

		cj_01.consignarDineroTarjeta(tj_01, "54321", 5, 10, 15, 20);
