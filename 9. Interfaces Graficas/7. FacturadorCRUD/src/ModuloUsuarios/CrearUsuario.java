...
public class CrearUsuario extends javax.swing.JFrame {
    ...
    public CrearUsuario(Menu ventanaMenu, Persona [] listaPersonas, int indexLista) {
    ...
    private void initComponents() {
        ...
        etq_CrearUsuario.setForeground(new java.awt.Color(255, 255, 255));
        etq_CrearUsuario.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etq_CrearUsuario.setText("CREAR USUARIO");
        ...
        contenedorDatosUsuario.setBackground(new java.awt.Color(102, 153, 255));
