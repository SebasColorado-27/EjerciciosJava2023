...
public class EliminarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        etq_EliminarUsuario = new javax.swing.JLabel();
        ...
        etq_EliminarUsuario.setFont(new java.awt.Font("Arial", 1, 28)); // NOI18N
        etq_EliminarUsuario.setForeground(new java.awt.Color(255, 255, 255));
        etq_EliminarUsuario.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etq_EliminarUsuario.setText("ELIMINAR USUARIO");
        ...
        contenedorTituloLayout.setHorizontalGroup(
            ...
            .addComponent(etq_EliminarUsuario, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        contenedorTituloLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contenedorTituloLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(etq_EliminarUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                .addContainerGap())
        );

        contenedorDatosEliminarUser.setBackground(new java.awt.Color(102, 153, 255));
        ...
        campoCedula.setDisabledTextColor(new java.awt.Color(51, 51, 51));
                        ...
                        .addGroup(contenedorDatosEliminarUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(contenedorDatosEliminarUserLayout.createSequentialGroup()
                                ...
                                .addGroup(contenedorDatosEliminarUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(campoCedula, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE))))
                        .addGap(0, 16, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contenedorDatosEliminarUserLayout.createSequentialGroup()
    ...
    private void btnBuscarCedulaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarCedulaActionPerformed
        String numeroCedula = campoBusCedula.getText();
        ...
        for (int i = 0; i < this.ventanaMenu.listaClientes.length; i++) {
            ...
            if (this.ventanaMenu.listaClientes[i] != null && this.ventanaMenu.listaClientes[i].getCedula().equals(numeroCedula)) {
                ...
                campoCedula.setText(this.ventanaMenu.listaClientes[i].getCedula());
    ...
    private void btnEliminarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarUsuarioActionPerformed
        this.ventanaMenu.listaClientes[posicioneliminar] = null;

        // Desplazar las siguientes posiciones hacia atrás
        for (int i = posicioneliminar + 1; i < this.ventanaMenu.listaClientes.length; i++) {
            this.ventanaMenu.listaClientes[i - 1] = this.ventanaMenu.listaClientes[i];
        }
        this.ventanaMenu.listaClientes[this.ventanaMenu.listaClientes.length - 1] = null;
 ...
 public void initAlternComponents(){
    ...
    private javax.swing.JLabel etq_EliminarUsuario;
