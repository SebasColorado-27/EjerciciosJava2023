...
public class ModificarVendedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        campoBusCedulaVen = new javax.swing.JTextField();
        ...
        btnBuscarModVen = new javax.swing.JButton();
        ...
        contentTitulo.setBackground(new java.awt.Color(255, 153, 0));

        etqTitulo.setFont(new java.awt.Font("Arial", 1, 28)); // NOI18N
        etqTitulo.setForeground(new java.awt.Color(255, 255, 255));
        etqTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etqTitulo.setText("MODIFICAR VENDEDOR");
        ...
        contentPrincipal.setBackground(new java.awt.Color(255, 204, 102));

        etqCedula.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        etqCedula.setForeground(new java.awt.Color(0, 0, 0));
        etqCedula.setText("Cedula:");

        campoBusCedulaVen.setBackground(new java.awt.Color(255, 255, 255));
        campoBusCedulaVen.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        campoBusCedulaVen.setForeground(new java.awt.Color(0, 0, 0));
        campoBusCedulaVen.setMargin(new java.awt.Insets(2, 5, 2, 5));
        ...
        btnBuscarModVen.setBackground(new java.awt.Color(255, 153, 0));
        btnBuscarModVen.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        btnBuscarModVen.setForeground(new java.awt.Color(255, 255, 255));
        btnBuscarModVen.setText("BUSCAR");
        btnBuscarModVen.setFocusable(false);
        btnBuscarModVen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuscarModVenActionPerformed(evt);
            }
        });

        etq_Buscando.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        etq_Buscando.setForeground(new java.awt.Color(51, 51, 51));
        etq_Buscando.setText("Usuario encontrado:");
        ...
        contentPrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contentPrincipalLayout.createSequentialGroup()
                ...
                .addComponent(campoBusCedulaVen, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnBuscarModVen)
            ...
            .addGroup(contentPrincipalLayout.createSequentialGroup()
                .addGap(34, 34, 34)
                .addComponent(etq_Buscando, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        contentPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(contentPrincipalLayout.createSequentialGroup()
                ...
                .addGroup(contentPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(campoBusCedulaVen, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnBuscarModVen, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(etq_Buscando, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBuscarModVenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarModVenActionPerformed
        String numeroCedula = campoBusCedulaVen.getText();
        boolean usuarioEncontrado = false;

        for (int i = 0; i < this.ventanaMenu.listaVendedores.length; i++) {
            if (this.ventanaMenu.listaVendedores[i] != null && this.ventanaMenu.listaVendedores[i].getCedula().equals(numeroCedula)) {
                etq_Buscando.setText("Usuario Encontrado");
                campoNombres.setText(this.ventanaMenu.listaVendedores[i].getNombres());
                campoApellidos.setText(this.ventanaMenu.listaVendedores[i].getApellidos());
                campoTelefono.setText(this.ventanaMenu.listaVendedores[i].getTelefono());
                campoDireccion.setText(this.ventanaMenu.listaVendedores[i].getDireccion());
                campoEmail.setText(this.ventanaMenu.listaVendedores[i].getEmail());
        ...
        if (!usuarioEncontrado) {
            etq_Buscando.setText("Usuario No Encontrado");
    ...
    }//GEN-LAST:event_btnBuscarModVenActionPerformed
    ...
    private javax.swing.JButton btnBuscarModVen;
    private javax.swing.JButton btnCancelar;
    private javax.swing.JButton btnRegistrar;
    private javax.swing.JTextField campoApellidos;
    private javax.swing.JTextField campoBusCedulaVen;
