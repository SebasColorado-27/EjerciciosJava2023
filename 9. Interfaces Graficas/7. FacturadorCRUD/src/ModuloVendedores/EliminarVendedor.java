...
public class EliminarVendedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        contenedorTitulo.setBackground(new java.awt.Color(255, 153, 0));
        ...
        contenedorTituloLayout.setHorizontalGroup(
            ...
            .addComponent(etq_EliminarUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        contenedorDatosEliminarUser.setBackground(new java.awt.Color(255, 204, 102));
        ...
        btnBuscarCedula.setBackground(new java.awt.Color(255, 153, 51));
        ...
        btnEliminarUsuario.setBackground(new java.awt.Color(255, 153, 51));
    ...
    private void btnBuscarCedulaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarCedulaActionPerformed
        ...
        for (int i = 0; i < this.ventanaMenu.listaVendedores.length; i++) {
            ...
            if (this.ventanaMenu.listaVendedores[i] != null && this.ventanaMenu.listaVendedores[i].getCedula().equals(numeroCedula)) {
                ...
                campoCedula.setText(this.ventanaMenu.listaVendedores[i].getCedula());
    ...
    private void btnEliminarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarUsuarioActionPerformed
        this.ventanaMenu.listaVendedores[posicioneliminar] = null;

        // Desplazar las siguientes posiciones hacia atrás
        for (int i = posicioneliminar + 1; i < this.ventanaMenu.listaVendedores.length; i++) {
            this.ventanaMenu.listaVendedores[i - 1] = this.ventanaMenu.listaVendedores[i];
        }
        this.ventanaMenu.listaVendedores[this.ventanaMenu.listaVendedores.length - 1] = null;
