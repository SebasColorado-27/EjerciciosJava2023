...
public class CrearVendedor extends javax.swing.JFrame {
    ...
    public CrearVendedor(Menu ventanaMenu, Persona [] listaPersonas, int indexLista) {
    ...
    private void initComponents() {
        ...
        contentTitulo.setBackground(new java.awt.Color(255, 204, 0));

        etqTitulo.setBackground(new java.awt.Color(255, 204, 0));
        etqTitulo.setFont(new java.awt.Font("Arial", 1, 28)); // NOI18N
        etqTitulo.setForeground(new java.awt.Color(255, 255, 255));
        etqTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etqTitulo.setText("CREAR VENDEDOR");
