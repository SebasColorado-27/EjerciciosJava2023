...
public class ListarVendedores extends javax.swing.JFrame {
    ...
    public ListarVendedores(Menu ventanaMenu, Persona [] listaVendedores, int indexVendedores) {
        this.ventanaMenu = ventanaMenu;
        this.listaPersonas = listaVendedores;
        this.indexLista = indexVendedores;
    ...
    private void initComponents() {
        ...
        principalContainer.setBackground(new java.awt.Color(255, 204, 102));

        EtqTitulo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        EtqTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        EtqTitulo.setText("LISTAR VENDEDORES");
